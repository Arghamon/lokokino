...
$(document).ready(function(){
    alert('asd')
    $('div.quiz_item').click(function() {
		// $(this).toggleClass('active');
		if($(this).find('input:checkbox[name=checkType]').is(":checked")) {
			$(this).find('input:checkbox[name=checkType]').prop("checked", false);
		}
		else{
			$(this).find('input:checkbox[name=checkType]').prop("checked", true);
		}
	});
